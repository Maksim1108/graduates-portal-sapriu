            ...
            <div class="card">
              ...
              <div v-else class="graduate-form">
                <div class="form-progress">
                  ...
                  <span class="progress-text">{{ Math.round(formProgress) }}% {{ t('заполнено', 'completed') }}</span>
                </div>
...
const formProgress = computed(() => {
  const fields = [
    ...
    formData.value.city,
    formData.value.work_place,
    formData.value.position,
    formData.value.field_activety,
    formData.value.best_practices,
    formData.value.education && formData.value.education[0] && formData.value.education[0].year_graduation,
    formData.value.education && formData.value.education[0] && formData.value.education[0].qualification,
    formData.value.education && formData.value.education[0] && formData.value.education[0].specialty
  ]
