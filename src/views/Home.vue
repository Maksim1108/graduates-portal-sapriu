...
const fetchHomeData = async () => {
  try {
    ...
    // Fallback banner image to keep UI functional if API fails
...
onMounted(async () => {
  ...
  // Initialize swipers immediately
  initializeBannerSwiper()
  initializePartnersSwiper()
  initializeNewsSwiper()

  // Reveal second banner image shortly after init (parity with old UX)
  setTimeout(() => {
...
// Language-dependent computed fields for dynamic content
